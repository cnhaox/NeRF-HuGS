...
def visualize_suite(rendering, rays):
  ...
  if 'rgb_combined' in rendering:
    vis['color_combined'] = rendering['rgb_combined']
  if 'rgb_static' in rendering:
    vis['color_static'] = rendering['rgb_static']
  if 'rgb_transient' in rendering:
    vis['color_transient'] = rendering['rgb_transient']
