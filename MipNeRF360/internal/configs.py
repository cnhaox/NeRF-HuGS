...
class Config:
  ...
  image_num_per_batch: int = 64 # The number of sampled images in each batch.
  ...
  vis_decimate: int = 0
  transient_type: Optional[str] = None # 'robustnerf', 'nerfw', 'hanerf'
  ...
  enable_render_zero_glo: bool = False
  enable_render_zero_tra: bool = False
  
  # robustnerf loss
  robustnerf_inlier_quantile: float = 0.5
  robustnerf_inlier_quantile_static: float = 0.95
  ...
  # hanerf loss
  hanerf_mask_size_loss_mult_min: float = 6.0e-3
  hanerf_mask_size_loss_mult_max: float = 5.0e-2
  hanerf_mask_size_loss_mult_k: float = 1.0e-3

  # withmask loss
  withmask_transient_weight: float = 0
  static_mask_dir_name: str = "static_masks"

  finetune_enable: bool = False
  finetune_max_steps: int = 5000
  finetune_batch_size: int = batch_size
  finetune_patch_size: int = patch_size
  finetune_patch_dilation: int = patch_dilation
  finetune_image_num_per_batch: int = image_num_per_batch
  
  finetune_lr_init: float = 0.005  # The initial learning rate.
  finetune_lr_final: float = 0.0005  # The final learning rate.
  finetune_lr_delay_steps: int = 500 # The number of "warmup" learning steps.
  finetune_lr_delay_mult: float = 0.01  # How much sever the "warmup" should be.
  finetune_adam_beta1: float = 0.9  # Adam's beta2 hyperparameter.
  finetune_adam_beta2: float = 0.999  # Adam's beta2 hyperparameter.
  finetune_adam_eps: float = 1e-8  # Adam's epsilon hyperparameter.
  ...
  render_embed_idx: Optional[int] = None
