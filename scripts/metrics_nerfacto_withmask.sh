...
#### distractor
EXPERIMENT_DIR=nerfacto/nerf_results/distractor_nerfacto_withmask
SCENES=(t_balloon_statue and-bot crab yoda)
IMAGE_TYPE=whole
#### kubric
# EXPERIMENT_DIR=nerfacto/nerf_results/kubric_nerfacto_withmask
# SCENES=(kubric_car kubric_cars kubric_bag kubric_chair kubric_pillow)
# IMAGE_TYPE=whole
#### phototourism
# EXPERIMENT_DIR=nerfacto/nerf_results/phototourism_nerfacto_withmask
