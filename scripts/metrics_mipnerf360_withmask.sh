...
#### distractor
EXPERIMENT_DIR=MipNeRF360/nerf_results/distractor_1024_glo4_withmask
SCENES=(t_balloon_statue and-bot crab yoda)
IMAGE_TYPE=whole
#### kubric
# EXPERIMENT_DIR=/mnt/data-ssd/code-20240206/MipNeRF360/nerf_results/kubric_1024_withmask
# SCENES=(kubric_car kubric_cars kubric_bag kubric_chair kubric_pillow)
# IMAGE_TYPE=whole
#### phototourism
# EXPERIMENT_DIR=MipNeRF360/nerf_results/phototourism_1024_withmask
